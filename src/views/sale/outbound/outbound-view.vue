    ...
    'form.otherAmount': {
      handler(newVal, oldVal) {
        if (this.form.discountRate !== 0) {
          ...
          this.form.afterDiscountReceiveAmount = this.$math.format(this.$math.multiply(this.$math.add(temp, newVal), this.form.discountRate + 1), { precision: 2, notation: 'fixed' })
        } else {
