    ...
    'form.otherAmount': {
      handler(newVal, oldVal) {
        if (this.form.discountRate !== 0) {
          ...
          this.form.afterDiscountReceiveAmount = this.$math.format(this.$math.multiply(this.$math.add(temp, newVal), this.$math.add(this.$math.multiply(this.form.discountRate, 0.01), 1)), { precision: 2, notation: 'fixed' })
        } else {
