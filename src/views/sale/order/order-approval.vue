...
import { getSalesOrderByCode, getSalesOrderById } from '@/api/business/sales-order'
import { getOutByCode } from '@/api/business/sales-out'
...
export default {
  ...
  data() {
    return {
      showForm: false,
      contentText: '审核销售单',
      saveUrl: '/api/sales/order/update',
      submitUrl: '/api/sales/order/update-and-submit',
      canSubmit: true,
      collapseConfig: [
  ...
  async created() {
    ...
    await getSalesOrderByCode(this.$route.params.code).then(res => {
