...
import { getProcurementOrderByCode, getProcurementOrderById } from '@/api/business/procurement-order'
...
export default {
  ...
  async created() {
    ...
    await getProcurementOrderByCode(this.$route.params.code).then(res => {
