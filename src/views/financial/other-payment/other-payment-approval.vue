...
import {getOtherPaymentByCode, getOtherPaymentById} from '@/api/business/other-payment'
...
export default {
  ...
  data() {
    return {
      showForm: false,
      contentText: '其他支出',
      saveUrl: '/api/financial-other-payment/update',
      submitUrl: '/api/financial-other-payment/update-and-submit-single',
      canSubmit: true,
      collapseConfig: [
  ...
  async created() {
    ...
    await getOtherPaymentByCode(this.$route.params.code).then(res => {
