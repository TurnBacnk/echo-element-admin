...
export default {
  ...
  data() {
    return {
      showForm: false,
      contentText: '资金转账登记',
      saveUrl: '/api/financial-fund-transfer/save',
      submitUrl: '/financial-fund-transfer/save-and-submit-single',
      canSubmit: true,
      collapseConfig: [
  ...
  async created() {
    await generateCode('FUND_TRANSFER').then(res => {
      this.form.transferCode = res.data
    })
