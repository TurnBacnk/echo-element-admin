...
import { getAssemblyByCode } from '@/api/business/assembly'
...
export default {
  ...
  data() {
    return {
      showForm: false,
      contentText: '组装单修改',
      saveUrl: '/api/repo-assembly/update',
      submitUrl: '/api/repo-assembly/update-and-submit-single',
      canSubmit: true,
      collapseConfig: [
  ...
  async created() {
    ...
    await getAssemblyByCode(this.$route.params.code).then(res => {
